...
const kFiles = [kPrimordials, kInspect, "internal/errors", "internal/util", "internal/util/types"];
...
export async function forwardConsole(context: ivm.Context, util: ReturnType<typeof create> extends Promise<infer T> ? T : never) {
	...
	context.evalClosureSync(
		...
		`,
		[util.formatWithOptions.derefInto(), util.inspect.derefInto(), new ivm.Reference(print)]
	);
}
